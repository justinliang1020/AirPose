...
PoseVRDriver::ControllerDevice::ControllerDevice(std::string serial, ControllerDevice::Handedness handedness):
    serial_(serial),
    handedness_(handedness)
{
}

std::string PoseVRDriver::ControllerDevice::GetSerial()
{
    return this->serial_;
}

void PoseVRDriver::ControllerDevice::Update()
{
...
DeviceType PoseVRDriver::ControllerDevice::GetDeviceType()
{
    return DeviceType::CONTROLLER;
}

PoseVRDriver::ControllerDevice::Handedness PoseVRDriver::ControllerDevice::GetHandedness()
{
    return this->handedness_;
}

vr::TrackedDeviceIndex_t PoseVRDriver::ControllerDevice::GetDeviceIndex()
{
    return this->device_index_;
}

vr::EVRInitError PoseVRDriver::ControllerDevice::Activate(uint32_t unObjectId)
{
...
void PoseVRDriver::ControllerDevice::Deactivate()
{
    this->device_index_ = vr::k_unTrackedDeviceIndexInvalid;
}

void PoseVRDriver::ControllerDevice::EnterStandby()
{
}

void* PoseVRDriver::ControllerDevice::GetComponent(const char* pchComponentNameAndVersion)
{
    return nullptr;
}

void PoseVRDriver::ControllerDevice::DebugRequest(const char* pchRequest, char* pchResponseBuffer, uint32_t unResponseBufferSize)
{
    if (unResponseBufferSize >= 1)
        pchResponseBuffer[0] = 0;
}

vr::DriverPose_t PoseVRDriver::ControllerDevice::GetPose()
{
    return last_pose_;
}
